    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            <Button href={docUrl('usage.html')}>Get Started</Button>
            <Button href="https://github.com/ozcanyarimdunya/dj_threading" target='_blank'>Source code</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
